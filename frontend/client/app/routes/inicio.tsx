...
const Inicio = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <Modal isOpen={isOpen} onRequestClose={handleClose} style={{ overlay: { backgroundColor: 'rgba(0, 0, 0, 0.5)' }, content: { position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', backgroundColor: 'white', borderRadius: '5px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.5)', padding: '20px', maxWidth: '550px', width: '100%', height: '300px', maxHeight: '600px' } }}>
        <h4 style={{textAlign: 'center', fontSize: '30px', fontWeight: 'bold', color: '#141048'}}>AVISO</h4>
