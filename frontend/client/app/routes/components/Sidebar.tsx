...
import { FaUsers, FaProjectDiagram, FaTasks, FaCalendarTimes, FaBriefcase, FaRavelry, FaTumblr, FaIndent, FaCompass, FaPlusCircle, FaSyncAlt, FaTrashAlt, FaKey, FaHammer, FaClipboardList, FaCube, FaSatellite, FaFileArchive, FaBox, FaFileAlt, FaLock, FaUserSecret } from 'react-icons/fa';
    ...
    if (user_type!=='Admin')
    {
        ...
        return (
            <aside>
                ...
                <Navbar  title={"Hola " + firstName + " " + lastName +", te damos la bienvenida!"} options={menuOptions} />
                   
                 
                    <div className="fixed top-0 left-0 w-60 bg-blue-800" style={{ zIndex: '9999', overflowY: 'auto', height: '110%', overflowX: 'hidden' }}>       
    
    
    
                        <div className="flex items-center justify-center bg-blue-900 py-4 h-15" style={{ width: '240px', height: '55px' }}>
                            <img src={LogoNTT} alt="Logo de NTT DATA" style={{ width: '50%', height: 'auto' }} />
                        </div>
                        <ul className="flex flex-col flex-1 py-4">
    
    
                            <li className="flex items-center px-6 py-3 text-blue-300 hover:text-white hover:bg-blue-700" style={{ color: 'white' }}>
                        ...
                        <ul>
                            <li
                                ...
                                style={{ height: '12%', width: '240px', color: 'white', zIndex: '9997' }}
